                ...
                <div className="">
                    <div className="mb-4">
                        <ul className="flex justify-between flex-wrap -mb-px font-medium text-center w-[50%]" id="default-tab" role="tablist">
                            <li className="me-2" role="presentation">
                                < button className={`inline-block p-1 border-b-2 font-josefin font-semibold text-[24px] text-[#151875] ${activeTab === 'description' ? 'border-[#151875]' : 'border-transparent'}`} id="description-tab" onClick={() => setActiveTab('description')} type="button" role="tab" aria-controls="description" aria-selected= {activeTab === 'description'}>Description</button>
                            </li>
                            <li className="me-2" role="presentation">
                                < button className={`inline-block p-1 border-b-2 font-josefin font-semibold text-[24px] text-[#151875] ${activeTab === 'additional' ? 'border-[#151875] ' : 'border-transparent'}`} id="additional-tab" onClick={() => setActiveTab('additional')} type="button" role="tab" aria-controls="additional" aria-selected={activeTab === 'additional'}>Additional Info</button>
                            </li>
                            <li className="me-2" role="presentation">
                                <button className={`inline-block p-1 border-b-2 font-josefin font-semibold text-[24px] text-[#151875] ${activeTab === 'reviews' ? 'border-[#151875] ' : 'border-transparent'}`} id="reviews-tab" onClick={() => setActiveTab('reviews')} type="button" role="tab" aria-controls="reviews" aria-selected={activeTab === 'reviews'}>Reviews</button>
                            </li>
                            <li className="me-2" role="presentation">
                                <button className={`inline-block p-1 border-b-2 font-josefin font-semibold text-[24px] text-[#151875] ${activeTab === 'video' ? 'border-[#151875]' : 'border-transparent'}`} id="video-tab" onClick={() => setActiveTab('video')} type="button" role="tab" aria-controls="video" aria-selected={activeTab === 'video'}>Video</button>
                            </li>
                        </ul>
                    </div>
                    <div id="default-tab-content">
                        <div className={`${activeTab === 'description' ? 'block' : 'hidden'}`} id="description" role="tabpanel" aria-labelledby="description-tab">
                            <div className="mt-10">
                                <h5 className="font-josefin font-semibold text-[22px] text-[#151875]">Varius tempor.</h5>
                                <p className="font-josefin font-semibold text-[16px] text-[#A9ACC6] mt-4 mb-7">
                                ...
                                <h5 className="font-josefin font-semibold text-[22px] text-[#151875] ">More details</h5>
                                <div className="flex items-center mt-4 mb-3">
                                    <FaArrowRight className="text-[#2F1AC4] mr-2" />
                                    <p className="font-josefin font-semibold text-[16px] text-[#A9ACC6]">Aliquam dis vulputate vulputate integer sagittis. Faucibus ds diam arcu, nulla lobortis justo netus dis. Eu in fringilla vulputate nunc nec. Dui, massa viverr .</p>
                                </div>
                        ...
                        <div className={`${activeTab === 'video' ? 'block' : 'hidden'}`} id="video" role="tabpanel" aria-labelledby="video-tab">
                            <p className="font-lato font-normal text-[18px] text-[#FB4997]">Ruko Jara Sabar Karo </p>
                        </div>
                    </div>
                </div>
            </Container>
