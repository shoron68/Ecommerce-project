                ...
                <Container>
                    <div className=" flex justify-between">
                        <div className="w-[68%]">
                            ...
                            <p className=' font-lato font-normal text-[#8A8FB9] text-[16px] py-[10px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Velit dapibus est, nunc, montes, lacus consequat integer viverra. Sit morbi
                            ...
                            <div className=" flex justify-between py-[50px]">
                                <div className="w-[24%]">
                                    <div className="">
                                        ...
                                        <div className="">
                                            <h5 className=' font-josefin font-medium text-[19px] text-[#000000]'>Quam sed</h5>
                                            <div className=" flex gap-x-[10px]">
                                                <h4 className=' font-josefin font-medium text-[13px] text-[#232A69]'>$32.00</h4>
                                                <h4 className=' font-josefin font-medium text-[13px] text-[#FF38B0]'>$32.00</h4>
                            ...
                            <div className="w-[90%]">
                                ...
                                <div className="">
                                    <textarea name="" className='w-[782px] text-[#8A8FB9] font-lato h-[200px] border-[#8A8FB9] rounded-[4px]' placeholder='Write your comment*' id="">
                                    </textarea>
                                </div>
